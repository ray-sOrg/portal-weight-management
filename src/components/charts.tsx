  ...
  return (
    <div className="h-[230px] sm:h-[300px]">
      ...
      <AreaChart data={data} margin={{ top: 10, right: 10, bottom: 0, left: -12 }}>
        ...
        />
        <Area type="monotone" dataKey="weight" name="体重" stroke="#355e4d" strokeWidth={2.5} fill="url(#weightFill)" isAnimationActive={false} />
        <Line type="monotone" dataKey="movingAverage" name="移动均值" stroke="#caa760" strokeWidth={2} dot={false} isAnimationActive={false} />
      </AreaChart>
      </ResponsiveContainer>
    </div>
  )
  ...
  return (
    <div className="h-[220px] sm:h-[240px]">
      ...
      <LineChart data={data} margin={{ top: 10, right: 8, bottom: 0, left: -18 }}>
        ...
        <Tooltip contentStyle={{ border: '1px solid #dfe6e1', borderRadius: 8 }} />
  ...
  return (
    <div className="h-[230px] sm:h-[260px]">
      ...
      <BarChart data={data} margin={{ top: 10, right: 10, bottom: 0, left: -10 }}>
        ...
        <Tooltip contentStyle={{ border: '1px solid #dfe6e1', borderRadius: 8 }} />
        <Bar dataKey="weight" name="体重 kg" fill="#6f8f7c" radius={[6, 6, 0, 0]} isAnimationActive={false} />
